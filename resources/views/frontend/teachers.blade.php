    ...
    <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem; position: relative;">
        ...
        <div class="org-chart">
            <ul>
                <!-- Tingkat 1: Pembina -->
                <li>
                    <div class="org-card" data-aos="zoom-in-up" data-aos-delay="100" onclick="openStaffModal('PROF. DR. DIKY MUDHAKIR', 'PEMBINA', '{{ asset('images/Profil guru/Sachou Diky.jpeg') }}', 'Sebagai Pembina Yayasan Kiseki Indonesia, beliau memberikan arahan strategis dan pengawasan terhadap seluruh program pendidikan dan pelatihan agar senantiasa relevan dengan kebutuhan industri di Jepang.')">
                        <div class="role-badge">PEMBINA</div>
                        <div class="img-container">
                            <img src="{{ asset('images/Profil guru/Sachou Diky.jpeg') }}" alt="Prof. Dr. Diky Mudhakir">
                        </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="org-card" data-aos="zoom-in-up" data-aos-delay="200" onclick="openStaffModal('ELLNOVIANTY NINE, M.HUM', 'DIREKTUR UTAMA', '{{ asset('images/Profil guru/Sachou Novi.jpeg') }}', 'Bertanggung jawab penuh atas operasional LPK Kiseki Indonesia. Memastikan standar kurikulum bahasa Jepang dan kedisiplinan kerja sesuai dengan standar tinggi perusahaan Jepang.')">
                                <div class="role-badge">DIREKTUR UTAMA</div>
                                <div class="img-container">
                                    <img src="{{ asset('images/Profil guru/Sachou Novi.jpeg') }}" alt="Ellnovianty Nine, M.Hum">
                                </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="org-card" data-aos="zoom-in-up" data-aos-delay="500" onclick="openStaffModal('TUBAGUS FAIZ AFIF', 'TIM PENDIDIKAN BAHASA JEPANG', '{{ asset('images/Profil guru/Faiz.jpeg') }}', 'Membantu persiapan siswa dalam menghadapi ujian JLPT/JFT-Basic serta membimbing latihan simulasi wawancara dengan User Jepang.')">
                                                        <div class="img-container">
                                                            <img src="{{ asset('images/Profil guru/Faiz.jpeg') }}" alt="Tubagus Faiz">
                                                        </div>
                                                        <div class="name-badge">TUBAGUS FAIZ AFIF</div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="org-card" data-aos="zoom-in-up" data-aos-delay="600" onclick="openStaffModal('KEYSHA AMANDA RAMDHANI', 'TIM PENDIDIKAN BAHASA JEPANG', '{{ asset('images/Profil guru/Kesha.jpeg') }}', 'Berfokus pada pengajaran pendengaran (Choukai) dan pemahaman budaya kerja Jepang (Hourensou) agar kandidat siap mental.')">
                                                        <div class="img-container">
                                                            <img src="{{ asset('images/Profil guru/Kesha.jpeg') }}" alt="Keysha">
                                                        </div>
                                                        <div class="name-badge">KEYSHA AMANDA RAMDHANI</div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="org-card" data-aos="zoom-in-up" data-aos-delay="700" onclick="openStaffModal('AJENG BELLA PRATIWI', 'TIM PENDIDIKAN BAHASA JEPANG', '{{ asset('images/Profil guru/Ajeng.jpg') }}', 'Melatih huruf Kanji dan memperbanyak kosa kata (Goi) kandidat lewat metode yang mudah diingat.')">
                                                        <div class="img-container">
                                                            <img src="{{ asset('images/Profil guru/Ajeng.jpg') }}" alt="Ajeng">
                                                        </div>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="org-card" data-aos="zoom-in-up" data-aos-delay="600" onclick="openStaffModal('EEP SAEPULOH', 'TIM ADMIN-HUMAS', '{{ asset('images/Profil guru/Esa.jpeg') }}', 'Menjembatani komunikasi antara Kiseki dengan pihak luar, menyebarkan informasi publik, dan mengelola media sosial lembaga.')">
                                                        <div class="img-container">
                                                            <img src="{{ asset('images/Profil guru/Esa.jpeg') }}" alt="Eep">
                                                        </div>
                                                        <div class="name-badge">EEP SAEPULOH</div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="org-card" data-aos="zoom-in-up" data-aos-delay="700" onclick="openStaffModal('MUHAMAD MULKI MUALIM', 'TIM ADMIN-HUMAS', '{{ asset('images/Profil guru/Mulki.jpeg') }}', 'Menangani pendaftaran siswa baru, merapikan dokumen persyaratan magang, dan melayani pertanyaan calon peserta didik.')">
                                                        <div class="img-container">
                                                            <img src="{{ asset('images/Profil guru/Mulki.jpeg') }}" alt="Mulki">
                                                        </div>
                                ...
                                <li>
                                    <div class="org-card" data-aos="zoom-in-up" data-aos-delay="500" onclick="openStaffModal('AWALUDIN', 'KABID. PEREKRUTAN DALAM NEGERI', '{{ asset('images/Profil guru/Awaludin.jpeg') }}', 'Bertugas melakukan sosialisasi dan perekrutan kandidat potensial dari berbagai sekolah, LPK binaan, maupun masyarakat umum.')">
                                        <div class="role-badge" style="font-size:0.75rem;">KABID. PEREKRUTAN DALAM NEGERI</div>
                                        <div class="img-container">
                                            <img src="{{ asset('images/Profil guru/Awaludin.jpeg') }}" alt="Awaludin">
                                        </div>
