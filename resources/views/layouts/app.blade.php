...
<body>
    ...
    <footer>
        <div class="footer-content">
            <div>
                ...
                <p>{{ __('Membuka jalan masa depan cerah Anda di Jepang melalui pelatihan bahasa dan keterampilan profesional.') }}
                </p>
            </div>
            <div>
        ...
        <div class="footer-bottom">
            &copy; {{ date('Y') }} LPK KISEKI INDONESIA. {{ __('All rights reserved.') }}
        </div>
    </footer>
    ...
    <a href="https://wa.me/6282311677114" target="_blank" class="floating-wa" title="{{ __('Hubungi kami via WhatsApp') }}">
