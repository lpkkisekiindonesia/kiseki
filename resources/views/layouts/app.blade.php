...
<body>
    ...
    <nav class="navbar">
        <a href="{{ route('home') }}" class="logo">
            <img src="{{ asset('images/logo.jpeg') }}" alt="Logo LPK Kiseki" style="height: 45px; width: 45px; border-radius: 50%; object-fit: cover;">
    ...
    <a href="https://wa.me/6281234567890" target="_blank" class="floating-wa" title="Hubungi kami via WhatsApp">
